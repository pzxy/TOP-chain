#unset cmake cache 
CMAKE_EXTRA_OPTIONS+=" -UXBUILD_TEST -UDISABLE_PLUGIN -UDISABLE_EVM -UDISABLE_RATELIMIT -UDISABLE_REAL_STAKE -UMAINNET_ACTIVATED -USTATIC_CONSENSUS -UELECT_WHEREAFTER -UCONSENSUS_SWAP"
...
do
    ...
    ;;
    disable_plugin)
        CMAKE_EXTRA_OPTIONS+=" -DDISABLE_PLUGIN=ON"
        echo "BUILD PLUGIN(need cargo toolchain)"
    ;;
    leak_trace)
